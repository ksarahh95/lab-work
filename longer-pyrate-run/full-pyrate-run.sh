...
#download the data
wget -O canidae_occ.csv "https://paleobiodb.org/data1.2/occs/list.csv?base_name=canidae&show=acconly"
...
Rscript process_canidae_data.R
...
# And then, run PyRate!
python ~/PyRate/PyRate.py canidae_occ_PyRate.py -n 250000
