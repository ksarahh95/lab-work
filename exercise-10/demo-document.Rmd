...
![Here is a forest in Papua New Guinea](/home/eeb177-student/Desktop/eeb-177/Lab-Work/exercise-10/tropical-forest.jpg)
...
\begin{figure}[t]
\label{fig:pop}
\includegraphics[width=15cm, height=15cm,keepaspectratio]{/home/eeb177-student/Desktop/eeb-177/Lab-Work/exercise-10/tropical-forest.jpg}
\centering
...
```{python, eval=F} 
f <-open("/path/to/file")#make markdown
lines. = f.readlines()
```